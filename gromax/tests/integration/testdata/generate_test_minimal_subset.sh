...
for i in $(seq 1 ${ntrials}); do
  ...
  $gmx -bonded cpu -deffnm group_${group}_trial_${i}_component_2 -gputasks 0 -nb gpu -noconfout -nsteps ${nsteps} -nstlist 80 -nt 2 -ntmpi 1 -ntomp 2 -pin on -pinoffset 2 -pinstride 1 -pme cpu -resetstep ${resetstep} -s ${tpr} -update cpu
  wait
  cd ${groupdir}
done
...
for i in $(seq 1 ${ntrials}); do
  ...
  $gmx -bonded gpu -deffnm group_${group}_trial_${i}_component_2 -gputasks 00 -nb gpu -noconfout -nsteps ${nsteps} -nstlist 80 -nt 2 -ntmpi 1 -ntomp 2 -pin on -pinoffset 2 -pinstride 1 -pme gpu -resetstep ${resetstep} -s ${tpr} -update gpu
  wait
  cd ${groupdir}
done
...
for i in $(seq 1 ${ntrials}); do
  ...
  $gmx -bonded cpu -deffnm group_${group}_trial_${i}_component_2 -gputasks 00 -nb gpu -noconfout -nsteps ${nsteps} -nstlist 80 -nt 2 -ntmpi 2 -ntomp 1 -pin on -pinoffset 2 -pinstride 1 -pme cpu -resetstep ${resetstep} -s ${tpr} -update cpu
  wait
  cd ${groupdir}
done
...
for i in $(seq 1 ${ntrials}); do
  ...
  $gmx -bonded gpu -deffnm group_${group}_trial_${i}_component_2 -gputasks 00 -nb gpu -noconfout -npme 1 -nsteps ${nsteps} -nstlist 80 -nt 2 -ntmpi 2 -ntomp 1 -pin on -pinoffset 2 -pinstride 1 -pme gpu -resetstep ${resetstep} -s ${tpr} -update gpu
  wait
  cd ${groupdir}
done
